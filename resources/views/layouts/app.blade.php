...
<head>
    ...
    <style>
        ...
        .navbar-nav .btn {
            min-width: 120px;
            /* Asegura un ancho mínimo para los botones de la navbar */
            margin-bottom: 5px;
            /* Pequeño margen para pantallas pequeñas */
        }

        @media (min-width: 992px) {

            /* Para pantallas grandes, volver a alinear los botones */
            .navbar-nav .btn {
                margin-bottom: 0;
            }
        }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-1">
                        <a class="btn btn-secondary" href="/clientes">Listar Clínicas</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="btn btn-success" href="{{ route('productos.create') }}">Crear Producto</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="btn btn-info" href="/productos">Listar Productos</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="btn btn-warning" href="{{ route('albaranes.create') }}">Crear Albarán</a> {{-- ¡Botón habilitado! --}}
                    </li>
                    <li class="nav-item mx-1">
                        <a class="btn btn-danger" href="/albaranes">Listar Albaranes</a>
                    </li>
                    <li class="nav-item mx-1">
                    ...
                    <li class="nav-item mx-1">
                        ...
                        <a class="btn btn-dark" href="/facturas">Listar Facturas</a>
                    </li>
                    <li class="nav-item mx-1">
